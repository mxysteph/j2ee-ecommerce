...
<title>Blitz - Successful Purchase</title>
<meta charset="UTF-8">
...
<body>
	...
	<div class="w3-top">
		<div class="w3-white w3-xlarge"
			...
			<div class="w3-center w3-padding-16">Successful Purchase</div>
		</div>
	</div>
	...
	<div class="w3-main w3-content w3-padding"
		...
		<div class="w3-row-padding w3-padding-16 w3-center">
				<div class="w3-container w3-padding-10 w3-center">
					<p> Thank you for your purchase! Our representatives will be contacting you with the delivery timeslot.</p>
					 <a href="<%=path%>/listingPageServlet"> <p> Continue Shopping </p> </a>
				</div>
			</div>
		</div>
	</div>
